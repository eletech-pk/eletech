    ...
    return (
        ...
        >
            ...
            <div className="relative aspect-video w-full bg-zinc-900/50 overflow-hidden border-b border-white/5">
                ...
                {project.imageUrl ? (
                    <Image
                        ...
                        fill
                        priority={priority}
                        className={`object-cover transition-all duration-700 scale-[1.02] group-hover:scale-100 ${project.videoUrl && isHovered ? 'opacity-0' : 'opacity-80 group-hover:opacity-100'}`}
                    />
                ) : (
            ...
            <div className="p-4 sm:p-8 flex flex-col flex-grow">
                <h3 className="text-lg sm:text-2xl font-bold text-white mb-2 sm:mb-3 group-hover:text-primary transition-colors">
                    {project.title}
                </h3>
                <p className="text-gray-400 mb-4 sm:mb-8 line-clamp-3 text-xs sm:text-base leading-relaxed">
                ...
                <div className="mt-auto">
                    <Button asChild variant="secondary" size="sm" className="w-full sm:h-10 rounded-full bg-white/10 text-white hover:bg-white/20 hover:text-white border-0 transition-colors pointer-events-auto z-10 relative text-xs sm:text-sm">
