            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-32">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center overflow-hidden">
                    <m.div
                        ...
                        className="relative group mx-auto w-full max-w-[280px] sm:max-w-[320px] md:max-w-none"
                    >
                    ...
                    <m.div
                        ...
                        viewport={{ once: true, margin: "-100px" }}
                        transition={{ duration: 0.8, ease: "easeOut" }}
                        className="mx-auto w-full max-w-[280px] sm:max-w-[320px] md:max-w-none"
                    >
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center overflow-hidden">
                    <m.div
                        ...
                        viewport={{ once: true, margin: "-100px" }}
                        transition={{ duration: 0.8, ease: "easeOut" }}
                        className="order-2 lg:order-1 mx-auto w-full max-w-[280px] sm:max-w-[320px] md:max-w-none"
                    >
                        <h3 className="text-3xl md:text-4xl font-display font-bold mb-6 dark:text-white">
                            Proven Results
                        </h3>
                    ...
                    <m.div
                        ...
                        viewport={{ once: true, margin: "-100px" }}
                        transition={{ duration: 0.8, ease: "easeOut" }}
                        className="order-1 lg:order-2 relative group mx-auto w-full max-w-[280px] sm:max-w-[320px] md:max-w-none"
                    >
                    ...
                    >
                        ...
                        <div className="relative bg-gradient-to-br from-blue-900/40 to-black border border-white/10 rounded-2xl p-2 aspect-square md:aspect-auto md:h-[400px] overflow-hidden flex items-center justify-center">
                            <m.div
                                ...
                                className="relative w-48 h-48 sm:w-64 sm:h-64 border-[16px] sm:border-[20px] border-blue-500/20 rounded-full backdrop-blur-sm"
                            />
                            <div className="absolute w-32 h-32 sm:w-48 sm:h-48 bg-blue-500/30 rounded-full blur-2xl flex items-center justify-center"></div>
